...
def valuesList(map, keylo, keyhi, cmp=None):
    """
    Retorna todas los valores del arbol que se encuentren entre
    [keylo, keyhi]
    ...
    Raises:
        Exception
    """
    return map['datastructure'].valuesList(map, keylo, keyhi, cmp)

def valuesListMap(map, keylo, keyhi, mapa_n, prop):
    """
    Retorna todas los valores del arbol que se encuentren entre
    [keylo, keyhi]
    ...
    Raises:
        Exception
    """
    return map['datastructure'].valuesMap(map, keylo, keyhi, mapa_n, prop)

def valuesListHeap(rbt, keylo, keyhi, cmp=None):
    """
    Retorna todas los valores del arbol que se encuentren entre
    [keylo, keyhi]
    ...
    Raises:
        Exception
    """
    return rbt['datastructure'].valueHeap(rbt, keylo, keyhi, cmp)

def valuesBelow(rbt, keyhi, cmpfunction, max=(False, None)): 
    return rbt['datastructure'].valuesBelow(rbt, keyhi, cmpfunction, max)

def valuesAbove(rbt, keyhi, cmpfunction, max=(False, None)): 
    return rbt['datastructure'].valuesAbove(rbt, keyhi, cmpfunction, max)

def valuesListMap1(map, keylo, keyhi, mapa_n):
    """
    Retorna todas los valores del arbol que se encuentren entre
    [keylo, keyhi]
    ...
    Raises:
        Exception
    """
    return map['datastructure'].valuesMap1(map, keylo, keyhi, mapa_n)
