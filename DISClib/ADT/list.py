...
def mini_sort1(lst, prop): 
    try:
        return lst['datastructure'].mini_sort1(lst, prop)
    except Exception as exp:
        error.reraise(exp, 'List->minisort: ')
...
def mini_sort(lst, prop): 
    try:
        return lst['datastructure'].mini_sort(lst, prop)
    except Exception as exp:
        error.reraise(exp, 'List->minisort: ')
